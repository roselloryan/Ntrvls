...
-(instancetype)initWithFrame:(CGRect)frame andImage:(UIImage *)image {
    ...
    if (self) {
        ...
        UIImageView *topCenterImageView = [[UIImageView alloc]initWithFrame: CGRectMake(self.frame.size.width/3, 0, self.frame.size.width/3, self.frame.size.height * 2/5)];
