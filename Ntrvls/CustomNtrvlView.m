...
- (instancetype)initWithFrame:(CGRect)frame intervalDescription:(NSString *)intervalDescription andDuration:(NSUInteger)duration isIPad:(BOOL)isIPad {
    ...
    if (self) {
        ...
        if (isIPad) {
            ...
            self.minutesTextField.frame = CGRectMake(8, self.descriptionTextView.frame.size.height + 30, frame.size.width / 2 - 16, frame.size.height / 4);
            self.secondsTextField.frame = CGRectMake(self.minutesTextField.frame.size.width + 24, self.descriptionTextView.frame.size.height + 30, frame.size.width / 2 - 16, frame.size.height / 4);
            ...
            colonLabel.frame = CGRectMake(0, self.descriptionTextView.frame.size.height + 26, frame.size.width, frame.size.height / 4);
            colonLabel.font = [UIFont systemFontOfSize: 40.0];
            self.descriptionTextView.font = [UIFont systemFontOfSize: 25.0 weight: UIFontWeightThin];
