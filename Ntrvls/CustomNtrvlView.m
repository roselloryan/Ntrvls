...
- (instancetype)initWithFrame:(CGRect)frame intervalDescription:(NSString *)intervalDescription andDuration:(NSUInteger)duration isIPad:(BOOL)isIPad {
    ...
    if (self) {
        ...
        if (isIPad) {
            self.descriptionTextView.frame = CGRectMake(8, 8, frame.size.width - 16, frame.size.height / 2.2);
            self.minutesTextField.frame = CGRectMake(8, self.descriptionTextView.frame.size.height + 20, frame.size.width / 2 - 16, frame.size.height / 4);
            self.secondsTextField.frame = CGRectMake(self.minutesTextField.frame.size.width + 24, self.descriptionTextView.frame.size.height + 20, frame.size.width / 2 - 16, frame.size.height / 4);
            self.intervalDurationLabel.frame = CGRectMake(0, self.descriptionTextView.frame.size.height + 16, frame.size.width, frame.size.height / 4);
            colonLabel.frame = CGRectMake(0, self.descriptionTextView.frame.size.height + 16, frame.size.width, frame.size.height / 4);
            colonLabel.font = [UIFont systemFontOfSize: 40.0];
            self.descriptionTextView.font = [UIFont systemFontOfSize: 20.0 weight: UIFontWeightThin];
            self.intervalDurationLabel.font = [UIFont systemFontOfSize: 30.0 weight: UIFontWeightThin];
            self.minutesTextField.font  = [UIFont systemFontOfSize: 30.0 weight: UIFontWeightThin];
            self.secondsTextField.font  = [UIFont systemFontOfSize: 30.0 weight: UIFontWeightThin];
        }
        else {
            ...
            self.minutesTextField.font  = [UIFont systemFontOfSize: 15.0 weight: UIFontWeightThin];
            self.secondsTextField.font  = [UIFont systemFontOfSize: 15.0 weight: UIFontWeightThin];
        }
